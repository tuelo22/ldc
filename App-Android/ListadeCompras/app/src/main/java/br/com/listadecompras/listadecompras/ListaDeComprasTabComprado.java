...
public class ListaDeComprasTabComprado extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_lista_de_compras_comprado, container, false);

        contexto = getActivity();

        RvProdutos = (RecyclerView) rootView.findViewById(R.id.rvprodutosemlistacomprado);
    ...
    public void CarregaListView() {
        if(lista != null & RvProdutos != null) {
            ArrayList<ListaDePreco> listapreco = ProcessaListaDePrecos.MontaListaProdutoPreco(lista.getIdLista(), contexto, StatusPrdEmLista.Comprado);
